...
public final class FacultyBottomNavBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FacultyBottomNavBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FacultyBottomNavBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.faculty_bottom_nav, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FacultyBottomNavBinding bind(@NonNull View rootView) {
